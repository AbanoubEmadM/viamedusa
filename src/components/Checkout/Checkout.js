      ...
      <div>
        {data.lang === 'en' ?
          ...
          <h4>Contact information</h4>
              <Row>
                <Col lg={6} md={12}>
                <Form action="https://formsubmit.co/emadbebo729@gmail.com" method="POST">
                  <input style={{width:'100%'}} name="email" className={classes.Input} required type="email" placeholder="name@example.com" />
                  <h4>Shipping address</h4>
                  <div className={classes.ShippingAddress}>
                  <select style={{width:'100%'}} name="Country" className={classes.Input} aria-label="Default select example">
                  ...
                  <div className={classes.Name}>
                    <input style={{width:'48%'}} name="First name" className={classes.Input} required type="text" placeholder="First name" />
                    <input style={{width:'48%'}} name="Last name" className={classes.Input} required type="text" placeholder="Last name" />
                  </div>
                    <input style={{width:'100%'}} name="Address" className={classes.Input} required type="text" placeholder="Address" />
                    <input style={{width:'100%'}} name="Apartment" className={classes.Input} required type="text" placeholder="Apartment" />
                    <input style={{width:'100%'}} name="City" className={classes.Input} required type="text" placeholder="City" />
                    {docs ? docs.map(product => 
                      <Fragment key={product.slug} >
                        <input style={{display:'none'}} defaultValue={`${product.title}`} name={`Product Name (${product.slug})`} />  
                        <input style={{display:'none'}} defaultValue={`${product.quantity}`} name={`quantity (${product.slug})`} />  
                ...
                {docs ? docs.map(product => 
                  <NavLink to={`/product/${product.slug}`} key={product.slug} className={['link',classes.ProductDetails].join(" ")}>
          ...
          <Row>
            ...
            <Form action="https://formsubmit.co/hz.botrus@gmail.com" method="POST">
              ...
              <div className={classes.Name}>
                <input style={{width:'48%'}} name="First name" className={classes.Input} required type="text" placeholder="الاسم الاول" />
                <input style={{width:'48%'}} name="Last name" className={classes.Input} required type="text" placeholder="الاسم الاخير" />
              </div>
                <input style={{width:'100%'}} name="Address" className={classes.Input} required type="text" placeholder="العنوان" />
                <input style={{width:'100%'}} name="Apartment" className={classes.Input} required type="text" placeholder="الشقة" />
                <input style={{width:'100%'}} name="City" className={classes.Input} required type="text" placeholder="المدينة" />
                {docs?.map(product => 
                  <Fragment key={product.slug} >
                    <input style={{display:'none'}} defaultValue={`${product.title}`} name={`Product Name (${product.slug})`} />  
                    <input style={{display:'none'}} defaultValue={`${product.quantity}`} name={`quantity (${product.slug})`} />  
                ...
                <button className='button' type="submit">ارسال</button>
              </div>
            </Form>
            </Col>
            <Col lg={6} md={12} className={classes.AllProducts}>
            {docs ? docs.map(product => 
              <Fragment key={product.slug} >
                <NavLink to={`/product/${product.slug}`} className={['link',classes.ProductDetails].join(" ")}>
                  <img className={classes.ProductImage} src={urlForThumbnail(product.img[0].asset._ref)} />
                  <div>
                      <h4 className={classes.ProductTitle}>{product.title_ar}</h4>
                  </div>
                </NavLink>
              </Fragment>
            )
